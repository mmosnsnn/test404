...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "919633687665") {
...
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 919633687665`)
...
XeonBotInc.sendMessage("919633687665@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
